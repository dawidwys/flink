    ...
    public void testTriggeringCheckpointWithFinishedChannels() throws Exception {
        ...
        try {
            ...
            try (StreamTaskMailboxTestHarness<String> testHarness =
                ...
                testHarness.processEvent(EndOfUserRecordsEvent.INSTANCE, 0, 0);
                ...
                // EndOfPartition.
                testHarness.processEvent(EndOfUserRecordsEvent.INSTANCE, 0, 1);
                testHarness.processEvent(EndOfUserRecordsEvent.INSTANCE, 0, 2);
