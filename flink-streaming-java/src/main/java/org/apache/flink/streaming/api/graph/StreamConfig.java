...
public class StreamConfig implements Serializable {
	...
	public void setTimerServiceProvider(InternalTimeServiceManagerProvider timerServiceProvider) {
	...
	public InternalTimeServiceManagerProvider getTimerServiceProvider(ClassLoader cl) {
		try {
