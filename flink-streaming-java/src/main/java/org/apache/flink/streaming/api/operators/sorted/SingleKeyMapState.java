 ...
 */
public class SingleKeyMapState<K, N, UK, UV>
		extends AbstractSingleKeyState<K, N, Map<UK, UV>>
		implements InternalMapState<K, N, UK, UV> {

	protected SingleKeyMapState(
	...
	static <UK, UV, SV, S extends State, IS extends S> IS create(StateDescriptor<S, SV> stateDesc) {
		return (IS) new SingleKeyMapState<>(
