...
public class SharedBufferTest extends TestLogger {
	...
	public void testSharedBuffer() throws Exception {
		...
		try (SharedBufferAccessor<Event> sharedBufferAccessor = sharedBuffer.getAccessor()) {
			...
			List<Map<String, List<EventId>>> patterns1 = sharedBufferAccessor.extractPatterns(b1, b1Version);
			...
			List<Map<String, List<EventId>>> patterns2 = sharedBufferAccessor.extractPatterns(b0, b0Version);
