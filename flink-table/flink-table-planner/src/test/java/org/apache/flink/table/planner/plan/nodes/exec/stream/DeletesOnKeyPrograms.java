 ...
 */
public final class DeletesOnKeyPrograms {
    ...
    public static final TableTestProgram INSERT_SELECT_DELETE_ON_KEY_DELETE_ON_KEY =
            TableTestProgram.of(
                            ...
                            "validates results when querying source with deletes on key"
                                    + " only, writing to sink supporting deletes on key only, which"
                    ...
                    .setupTableSource(
                            SourceTestStep.newBuilder("source_t")
                                    ...
                                    .addOption("source.produces-delete-on-key", "true")
                                    .producedValues(
                    ...
                    .setupTableSink(
                            SinkTestStep.newBuilder("sink_t")
                                    ...
                                    .addOption("sink.supports-delete-on-key", "true")
                                    .consumedValues(
                                            "+I[1, Alice, 10]",
                                            "+I[2, Bob, 20]",
                                            "-D[1, null, null]",
    ...
    // no ChangelogNormalize
    public static final TableTestProgram INSERT_SELECT_DELETE_ON_KEY_DELETE_ON_KEY_WITH_PROJECTION =
            TableTestProgram.of(
                            "select-delete-on-key-to-delete-on-key-with-projection",
                            "validates results when querying source with deletes on key"
                                    + " only, writing to sink supporting deletes on key only with a"
    ...
    // Changelog Normalize added
    public static final TableTestProgram INSERT_SELECT_DELETE_ON_KEY_FULL_DELETE =
            TableTestProgram.of(
                    ...
                    .setupTableSink(
                            SinkTestStep.newBuilder("sink_t")
                                    .addSchema(
                                            ...
                                            "`value` INT")
                                    .addOption("changelog-mode", "I,UA,D")
                                    .addOption("sink.supports-delete-on-key", "false")
                                    .consumedValues(
                                            "+I[1, Alice, 10]",
                                            "+I[2, Bob, 20]",
                                            "-D[1, Alice, 10]",
    ...
    public static final TableTestProgram INSERT_SELECT_FULL_DELETE_FULL_DELETE =
            TableTestProgram.of(
                            ...
                            "validates results when querying source with full deletes, "
                    ...
                    .setupTableSource(
                            SourceTestStep.newBuilder("source_t")
                                    .addSchema(
                                            ...
                                            "`value` INT")
                                    .addOption("changelog-mode", "I,UA,D")
                                    .addOption("source.produces-delete-on-key", "false")
                                    .producedValues(
                                            Row.ofKind(RowKind.INSERT, 1, "Alice", 10),
                                            Row.ofKind(RowKind.INSERT, 2, "Bob", 20),
                                            // Delete by key
    ...
    // ChangelogNormalize exists
    public static final TableTestProgram JOIN_INTO_FULL_DELETES =
            TableTestProgram.of(
                            "join-to-full-delete",
                            "validates results when joining sources with deletes on key"
    ...
    // no ChangelogNormalize
    public static final TableTestProgram JOIN_INTO_DELETES_ON_KEY =
            TableTestProgram.of(
                            "join-to-delete-on-key",
                            "validates results when joining sources with deletes on key"
                                    + " only, writing to sink supporting deletes on key, which"
