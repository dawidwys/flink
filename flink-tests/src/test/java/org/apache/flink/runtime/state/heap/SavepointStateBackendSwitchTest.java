...
public class SavepointStateBackendSwitchTest {
    ...
    @Test
    public void switchFromHeapToRocks() throws Exception {
        ...
        final KeyGroupsStateHandle stateHandle =
                (KeyGroupsStateHandle) stateHandles.getJobManagerOwnedSnapshot();
    ...
    private void takeHeapSavepoint(
            File pathToWrite,
        ...
        try (final CheckpointableKeyedStateBackend<String> keyedBackend =
                createHeapKeyedStateBackend(Collections.emptyList())) {
