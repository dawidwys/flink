 ...
 *
 * <p>The {@link InternalKeyedStateBackend} and {@link OperatorStateBackend} created by this state
...
public interface StateBackend extends java.io.Serializable {
	...
	// ------------------------------------------------------------------------
	/**
	 * Creates a new {@link InternalKeyedStateBackend} that is responsible for holding <b>keyed state</b>
