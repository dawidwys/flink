...
public class SavepointRestoreResult {
    ...
    private final ExceptionIterator<KeyGroup> restoredKeyGroups;

    public SavepointRestoreResult(
            List<StateMetaInfoSnapshot> stateMetaInfoSnapshots,
            ExceptionIterator<KeyGroup> groupsIterator) {
    ...
    public ExceptionIterator<KeyGroup> getRestoredKeyGroups() {
