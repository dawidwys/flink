...
import org.apache.flink.api.common.eventtime.CombinedWatermark.PartialWatermark;
...
public class WatermarkOutputMultiplexer {
    ...
    private final CombinedWatermark combinedWatermark;
    ...
    public WatermarkOutputMultiplexer(WatermarkOutput underlyingOutput) {
        ...
        this.combinedWatermark = new CombinedWatermark();
    }
    ...
    private void updateCombinedWatermark() {
        if (combinedWatermark.updateCombinedWatermark()) {
            underlyingOutput.emitWatermark(new Watermark(combinedWatermark.getCombinedWatermark()));
        } else if (combinedWatermark.isIdle()) {
    ...
    private class ImmediateOutput implements WatermarkOutput {
        ...
        public void emitWatermark(Watermark watermark) {
            ...
            // combined watermark
            if (wasUpdated && timestamp > combinedWatermark.getCombinedWatermark()) {
                updateCombinedWatermark();
            }
        }
